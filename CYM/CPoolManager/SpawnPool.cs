...
namespace CYM.Pool
{
    ...
    public sealed class SpawnPool : MonoBehaviour, IList<Transform>
    {
        ...
        /// </summary>
        private Transform Spawn(Transform prefab, Transform parent)
        {
        ...
        private Transform Spawn(GameObject prefab)
		{
			return Spawn(prefab.transform);
		}

        private Transform Spawn(GameObject prefab, Transform parent)
		{
        ...
        /// </summary>
        private Transform Spawn(string prefabName)
        {
        ...
        /// instance under the given parent
        /// </summary>
        private Transform Spawn(string prefabName, Transform parent)
        {
            Transform prefab = this.prefabs[prefabName];
        ...
        /// position and rotation.
        /// </summary>
        private Transform Spawn(string prefabName, Vector3 pos, Quaternion rot)
        {
            Transform prefab = this.prefabs[prefabName];
        ...
        private AudioSource Spawn(AudioSource prefab,
        ...
        private AudioSource Spawn(AudioSource prefab, Transform parent)
        {
            return this.Spawn
            (
                prefab, 
        ...
        private void Despawn(Transform instance)
        {
            ...
            instance.position = CYM.BaseConstMgr.FarawayPos;
        ...
        public IEnumerator<float> Prespawn(GameObject go, int count = 1, Vector3? position = null, Quaternion? quaternion = null, Transform paraent = null)
        {
        ...
        public Transform SpawnTrans(GameObject go, Vector3? position = null, Quaternion? quaternion = null, Transform paraent = null)
        {
            ...
            Transform ret = null;
            if (paraent == null)
                ret = Spawn(go, position.HasValue ? position.Value : BaseConstMgr.FarawayPos, quaternion.HasValue ? quaternion.Value : Quaternion.identity);
            else
                ret = Spawn(go, position.HasValue ? position.Value : BaseConstMgr.FarawayPos, quaternion.HasValue ? quaternion.Value : Quaternion.identity, paraent);
            return ret;
        }
