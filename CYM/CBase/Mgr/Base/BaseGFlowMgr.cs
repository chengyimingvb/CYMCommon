...
namespace CYM
{
    public class BaseGFlowMgr : BaseCoreMgr
    {
        #region prop
        protected IBaseBattleMgr BattleMgr=>SelfBaseGlobal.BattleMgr;
        protected BaseLuaMgr LuaMgr=>SelfBaseGlobal.LuaMgr;
        protected BaseLoaderMgr LoaderMgr=>SelfBaseGlobal.LoaderMgr;
        protected BaseDLCMgr ABMgr => SelfBaseGlobal.DLCMgr;
