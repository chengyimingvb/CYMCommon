...
namespace CYM.Utile
{
    ...
    namespace PrefsInternal {
        ...
        public abstract class XenoTemplatePrefsBase<TClass> where TClass : class {
    ...
    public abstract class XenoTemplatePrefs : PrefsInternal.XenoTemplatePrefsBase<Enum> {
        ...
        //------------------------------------------------------------------------------
        public static EditorUtils.EolType Eol {
            get {
                return GetEnumPref(PrefKey.Eol, EditorUtils.EolType.Unix);
            }
            set {
        ...
        public static void ValidatePrefs () {
            ...
            ValidateEnumPref(PrefKey.Eol, EditorUtils.EolType.Unix);
