...
namespace CYM.Utile
{
    ...
    public class XenoTemplateMapping : ScriptableObject, ISerializationCallbackReceiver {

        //
        // Public data
        //

        public Dictionary<String, XenoTemplateCustomMappingData> CustomMappings = new Dictionary<String, XenoTemplateCustomMappingData>();
        ...
        [SerializeField]
        private List<XenoTemplateCustomMappingData> m_customMappingValues = new List<XenoTemplateCustomMappingData>();
