...
namespace CYM.Utile
{
    ...
    [CustomEditor(typeof(XenoTemplateMapping))]
    public class XenoTemplateMappingInspector : Editor {

        //
        // Private data
        //

        private XenoTemplateMapping m_targetMapping = null;
        ...
        private void CustomMappingGUI () {
            ...
            for (int index = 0; index < mappingCount; ++index) {
                ...
                if (key != newKey) {
                    m_targetMapping.CustomMappings.Remove(key);
                    m_targetMapping.CustomMappings.Add(newKey, new XenoTemplateCustomMappingData(newScript, newMethodName));
                }
                else if (script != newScript || methodName != newMethodName) {
                    m_targetMapping.CustomMappings[key] = new XenoTemplateCustomMappingData(newScript, newMethodName);
                }
            ...
            if (addCustomMapping) {
                ...
                m_targetMapping.CustomMappings.Add(newKey, new XenoTemplateCustomMappingData());
                GUI.FocusControl(String.Empty);
            }
            EditorGUILayout.EndHorizontal();
        ...
        private void EnvironmentMappingGUI () {
            ...
            EditorUtils.EolStringToEolType("\r\n");
