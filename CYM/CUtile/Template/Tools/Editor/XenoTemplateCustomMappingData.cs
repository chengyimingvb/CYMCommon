...
namespace CYM.Utile
{
    ...
    [Serializable]
    public class XenoTemplateCustomMappingData {
        ...
        //------------------------------------------------------------------------------
        public XenoTemplateCustomMappingData () {
        ...
        //------------------------------------------------------------------------------
        public XenoTemplateCustomMappingData (MonoScript targetScript, String methodName) {
