...
namespace CYM.Utile
{
    ...
    [Serializable]
    public class XenoTemplateElement {
        ...
        //------------------------------------------------------------------------------
        public XenoTemplateElement (String elementName, String fileNameFormat, String extension, String contents) {
