...
namespace CYM.Utile
{
	...
	/// <br/>You almo may add it by hand to all cameras you wish to measure.
	...
	public class AFPSRenderRecorder : MonoBehaviour
	{
		...
		private void OnValidate()
		{
			...
			if (cam == null)
			{
				Debug.LogError(AFPSCounter.LOG_PREFIX + "Look like this AFPSRenderRecorder instance is added to the Game Object without Camera! It will not work.", this);
			}
		}
#endif
		...
		private void OnPreCull()
		{
			...
			{
				Debug.LogWarning(AFPSCounter.LOG_PREFIX + "You have this AFPSRenderRecorder instance running, " +
