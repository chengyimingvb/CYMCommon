...
namespace CYM.AI{
    ...
    public abstract class Node{
        ...
        public string CustomTypeName { get; set; } = BaseConstMgr.STR_None;
        public bool IsDrawChildren { get { return CustomTypeName == BaseConstMgr.STR_None; } }
    ...
    {
        public string Name = "";
        public BTTaskAttribute(string name)
        {
            Name = name;
        }
    }
