Shader "Ciconia Studio/Effects/Team Color/2Sided/Cutout/Fast" {
    Properties {
        [Space(15)][Header(Main Maps)]
        [Space(10)]_Color ("Color", Color) = (1,1,1,1)
        _MainTex ("Albedo (CutoutA)", 2D) = "white" {}
        ...
        [Space(25)]_MaskColor ("Color", Color) = (1,1,1,1)
        ...
        [Space(15)][Header(Cutout Properties)]
        ...
        _AlphaAmount ("Alpha Amount", Range(-0.5, 1)) = 0.2
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float Cutout = (lerp( lerp( (1.0 - node_1940), node_1940, _InvertAlbedoAlpha ), 1.0, _DisableAlbedoAlphaChannel )-_AlphaAmount);
                clip(Cutout - 0.5);
