...
namespace BeautifyEffect {
    ...
    public class Beautify : MonoBehaviour {
								...
								public const string SKW_SEPIA = "BEAUTIFY_SEPIA";
        ...
        Material bMat;
								...
								const string BEAUTIFY_BUILD_HINT = "BeautifyBuildHint56b1";
								...
								void OnEnable () {
												...
												if (EditorPrefs.GetInt (BEAUTIFY_BUILD_HINT) == 0) {
																...
																EditorUtility.DisplayDialog ("Beautify Update: User Action Required", "Beautify shaders have been updated. Please check the Shader Options button in Beautify's inspector for new shader capabilities and disable/enable features to optimize build size and compilation time.\n\nOtherwise when you build the game it will take a long time during shader compilation!", "Ok");
												}
#endif
								}
								...
								protected virtual void OnRenderImage (RenderTexture source, RenderTexture destination) {
												...
												if (requiresLuminanceComputation) {
																...
																if (rtEAacum == null) {
																				...
																				rtEAacum = new RenderTexture (rtEASmallDesc); // 2, 2, 0, rtFormat);
																				Graphics.Blit (rtEA [lumRT], rtEAacum, bMat, rawCopyPass);
																				rtEAHist = new RenderTexture (rtEASmallDesc); // 2, 2, 0, rtFormat);
