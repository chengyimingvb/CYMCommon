Shader "NatureManufacture Shaders/Old/Water River Tesseled"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata v )
		{
			...
			float temp_output_415_0 = ( ( _WaterTessScale * tex2Dlod( _WaterTesselation, half4( WaterSpeedValueMix516, 0.0 , 0.0 ) ).r ) + ( _WaterTessScale * tex2Dlod( _WaterTesselation, half4( WaterSpeedValueMain614, 0.0 , 0.0 ) ).r ) );
			...
			float temp_output_416_0 = ( ( ( tex2Dlod( _SmallCascadeWaterTess, half4( SmallCascadeSpeedValueMix433, 0.0 , 0.0 ) ).r * _SmallCascadeWaterTessScale ) + ( tex2Dlod( _SmallCascadeWaterTess, half4( SmallCascadeSpeedValueMain600, 0.0 , 0.0 ) ).r * _SmallCascadeWaterTessScale ) ) * clampResult285 );
			...
			float temp_output_566_0 = ( ( ( _BigCascadeWaterTessScale * tex2Dlod( _BigCascadeWaterTess, half4( BigCascadeSpeedValueMix608, 0.0 , 0.0 ) ).r ) + ( _BigCascadeWaterTessScale * tex2Dlod( _BigCascadeWaterTess, half4( BigCascadeSpeedValueMain432, 0.0 , 0.0 ) ).r ) ) * clampResult514 );
			float lerpResult568 = lerp( lerpResult407 , temp_output_566_0 , clampResult514);
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float clampResult584 = clamp( ( clampResult263 * ( 1.0 / temp_output_258_0 ) ) , 0.0 , 1.0 );
			float clampResult285 = clamp( pow( ( 1.0 - clampResult584 ) , _SmallCascadeAngleFalloff ) , 0.0 , 1.0 );
			float3 lerpResult330 = lerp( temp_output_24_0 , BlendNormals( UnpackScaleNormal( tex2D( _SmallCascadeNormal, SmallCascadeSpeedValueMix433 ) ,_SmallCascadeNormalScale ) , UnpackScaleNormal( tex2D( _SmallCascadeNormal, SmallCascadeSpeedValueMain600 ) ,_SmallCascadeNormalScale ) ) , clampResult285);
			float2 appendResult712 = (half2(_BigCascadeMixSpeed.y , _BigCascadeMixSpeed.x));
