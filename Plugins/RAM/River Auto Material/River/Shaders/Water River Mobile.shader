Shader "NatureManufacture Shaders/Water/Water River Mobile"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float Globaltiling775 = ( 1.0 / _GlobalTiling );
			float2 temp_output_777_0 = ( uv_WaterNormal * Globaltiling775 );
			float2 panner612 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _WaterMixSpeed :  appendResult706 ) + temp_output_777_0);
			float2 WaterSpeedValueMix516 = panner612;
			float2 appendResult705 = (half2(_WaterMainSpeed.y , _WaterMainSpeed.x));
			float2 panner611 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _WaterMainSpeed :  appendResult705 ) + temp_output_777_0);
			...
			float2 temp_output_778_0 = ( uv_WaterNormal * Globaltiling775 );
			float2 panner597 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _SmallCascadeMixSpeed :  appendResult709 ) + temp_output_778_0);
			...
			float2 panner598 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _SmallCascadeMainSpeed :  appendResult710 ) + temp_output_778_0);
			...
			float2 temp_output_780_0 = ( uv_WaterNormal * Globaltiling775 );
			float2 panner606 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _BigCascadeMixSpeed :  appendResult712 ) + temp_output_780_0);
			float2 BigCascadeSpeedValueMix608 = panner606;
			float2 appendResult714 = (half2(_BigCascadeMainSpeed.y , _BigCascadeMainSpeed.x));
			float2 panner607 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _BigCascadeMainSpeed :  appendResult714 ) + temp_output_780_0);
			...
			float2 panner116 = ( _Time.y * (( (float)Direction723 == 1.0 ) ? _FoamSpeed :  appendResult716 ) + ( uv_Foam * Globaltiling775 ));
			...
			float2 temp_output_766_0 = ( _NoiseTiling * ( i.uv_texcoord * Globaltiling775 ) );
			float2 panner646 = ( _SinTime.x * ( temp_output_743_0 * float2( -1.2,-0.9 ) ) + temp_output_766_0);
			half4 tex2DNode647 = tex2D( _CascadesTextures, panner646 );
			float2 panner321 = ( _SinTime.x * temp_output_743_0 + temp_output_766_0);
			...
			float lerpResult480 = lerp( 0.0 , tex2DNode319.r , clampResult488);
			float clampResult322 = clamp( pow( tex2DNode319.r , _SmallCascadeFoamFalloff ) , 0.0 , 1.0 );
			...
			float clampResult299 = clamp( pow( tex2DNode213.g , _BigCascadeFoamFalloff ) , 0.0 , 1.0 );
			...
			float lerpResult769 = lerp( _WaterSpecularFar , _WaterSpecularClose , pow( temp_output_94_0 , _WaterSpecularThreshold ));
			float lerpResult130 = lerp( lerpResult769 , _FoamSpecular , temp_output_114_0);
