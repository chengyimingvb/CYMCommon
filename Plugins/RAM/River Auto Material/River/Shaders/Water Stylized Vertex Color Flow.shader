Shader "NatureManufacture Shaders/Water/Water Stylized Vertex Color Flow"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float clampResult1065 = clamp( pow( ( temp_output_3_0 + ( 1.0 - _OutlinePower ) ) , ( 1.0 - _OutlineFalloffBorder ) ) , 0.0 , 1.0 );
			o.Emission = ( ( clampResult1065 * half4(1,1,1,0) ) * i.vertexColor.a ).rgb;
			...
			float clampResult1066 = clamp( i.vertexColor.a , 0.0 , 1.0 );
			float temp_output_779_0 = ( lerpResult208 * clampResult1066 );
