...
namespace AwesomeTechnologies.VegetationSystem
{
    ...
    public class VegetationPackagePro : ScriptableObject
    {
        ...
        public void PrepareNativeArrayTextureCurves()
        {
            ...
            {
                TerrainTextureSettingsList[i].HeightCurveArray = new NativeArray<float>(256, Allocator.Persistent);
                ...
                TerrainTextureSettingsList[i].HeightCurveArray.CopyFrom(TerrainTextureSettingsList[i].TextureHeightCurve.GenerateCurveArray());
                TerrainTextureSettingsList[i].SteepnessCurveArray = new NativeArray<float>(256, Allocator.Persistent);
                ...
                TerrainTextureSettingsList[i].SteepnessCurveArray.CopyFrom(TerrainTextureSettingsList[i].TextureSteepnessCurve.GenerateCurveArray());
            }
        }
