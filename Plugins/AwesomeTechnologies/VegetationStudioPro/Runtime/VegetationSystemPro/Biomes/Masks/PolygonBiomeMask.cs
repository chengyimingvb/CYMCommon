...
//                    vegetationSpawnLocationInstance.SpawnChance = math.@select(math.max((1 - SampleCurveArray(distanceToEdge / BlendDistance)) * (1 - perlinNoise), vegetationSpawnLocationInstance.SpawnChance), math.min(SampleCurveArray(distanceToEdge / BlendDistance) * perlinNoise, vegetationSpawnLocationInstance.SpawnChance), Include);
                    ...
                    //{
                    //    vegetationSpawnLocationInstance.SpawnChance =
                    //        math.max(vegetationSpawnLocationInstance.SpawnChance, originalSpawnChance);
                   // }
                }
