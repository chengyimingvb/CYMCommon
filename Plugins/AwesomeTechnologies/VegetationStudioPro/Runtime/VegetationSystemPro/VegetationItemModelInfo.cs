...
namespace AwesomeTechnologies.VegetationSystem
{
    ...
    public class VegetationItemModelInfo
    {
        ...
        void UpdateBillboardMaterial()
        {
            ...
            BillboardMaterial.SetColor("_SnowColor", EnvironmentSettings.SnowColor);
        ...
        {
            float[] curveArray = VegetationItemInfo.HeightRuleCurve.GenerateCurveArray();
            HeightRuleCurveArray.CopyFrom(curveArray);
        }

        public void UpdateSteepnessRuleCurve()
        {
            float[] curveArray = VegetationItemInfo.SteepnessRuleCurve.GenerateCurveArray();
